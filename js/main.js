...
const makeDeleteButton = () => {
  return `<button type="button" data-action="delete-task" class="btn btn-light align-self-end">Удалить</button>`;
};
...
const createTaskTemplate = (task) => {
  ...
  return `<li class="list-group-item d-flex justify-content-between" id="task${task.id}">
